...
const ICONS: Record<string, IconDefinition> = {
  ...
  'SK': STROKE_ICON([{ d: 'M8 5c-2 1.2-3 3-3 7s1 5.8 3 7' }, { d: 'M16 5c2 1.2 3 3 3 7s-1 5.8-3 7' }, { d: 'M13.5 4L10.5 20' }]),
  'ED': STROKE_ICON([
  ...
  'CT': STROKE_ICON([{ d: 'M4 6h16v12H4z' }, { d: 'M4 8h16' }, { d: 'M7 12l2 2-2 2' }, { d: 'M11.5 16H17' }]),
  'NC': STROKE_ICON([
    { d: 'M4 5h16v14H4z' },
    { d: 'M4 8h16' },
    { d: 'M7 12l2 2-2 2' },
  ...
  'DP': STROKE_ICON([{ d: 'M4 5h16v14H4z' }, { d: 'M4 9h16' }, { d: 'M9 9v10' }, { d: 'M12 13h5' }, { d: 'M12 16h3' }]),
  '30': STROKE_ICON([{ d: 'M4 6h16v12H4z' }, { d: 'M4 9h16' }, { d: 'M7 13l2 2-2 2' }, { d: 'M12 17h2' }, { d: 'M18 15v-3l2 1.5-2 1.5' }]),
  'ER': STROKE_ICON([
    { d: 'M12 9v4' },
    { d: 'M12 17h.01' },
    { d: 'M10.3 3.9L2.8 17a1 1 0 00.9 1.5h16.6a1 1 0 00.9-1.5L13.7 3.9a1 1 0 00-1.7 0z' }
  ]),
  'GO': STROKE_ICON([{ d: 'M3 11.5L21 3l-6.5 18-3.5-6.5L3 11.5z' }, { d: 'M10.9 14.4L21 3' }]),
  'HI': STROKE_ICON([
    { d: 'M4 6h16v12H4z' },
    { d: 'M4 7l8 6 8-6' },
    { d: 'M8.5 12L7 14l1.5 2', strokeWidth: 1.5 },
  ...
  'PH': STROKE_ICON([
    {
      d: 'M6.5 4h2A1.5 1.5 0 0110 5.1l.6 2.4a1.5 1.5 0 01-.4 1.4l-1.4 1.3a15 15 0 006 6l1.3-1.4a1.5 1.5 0 011.4-.4l2.4.6a1.5 1.5 0 011.1 1.5v2A2 2 0 0119 21h-1C10.3 21 3 13.7 3 6V5a1 1 0 011-1h2.5z'
    }
  ]),
  'LO': STROKE_ICON([{ d: 'M12 21s6-4.4 6-10a6 6 0 10-12 0c0 5.6 6 10 6 10z' }, { d: 'M12 13a2.5 2.5 0 100-5 2.5 2.5 0 000 5z' }]),
  'NE': STROKE_ICON([{ d: 'M12 12a4 4 0 100-8 4 4 0 000 8z' }, { d: 'M5 20a7 7 0 0114 0' }]),
  'preview': STROKE_ICON([{ d: 'M2 12s3.6-6 10-6 10 6 10 6-3.6 6-10 6-10-6-10-6z' }, { d: 'M12 15a3 3 0 100-6 3 3 0 000 6z' }]),
  'external': STROKE_ICON([{ d: 'M14 5h5v5' }, { d: 'M10 14L19 5' }, { d: 'M19 13v5a1 1 0 01-1 1H6a1 1 0 01-1-1V6a1 1 0 011-1h5' }]),
  'app-store': STROKE_ICON([{ d: 'M8 6l8 12' }, { d: 'M12 4l2 3' }, { d: 'M6 18h12' }, { d: 'M10 14l-2 4' }]),
  'play-store': STROKE_ICON([{ d: 'M6 4l12 8-12 8V4z' }]),
  'case-study': STROKE_ICON([{ d: 'M6 4h9a3 3 0 013 3v13H9a3 3 0 00-3 3V4z' }, { d: 'M18 20H9a3 3 0 00-3 3' }, { d: 'M10 9h5M10 13h5' }])
};
